                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    @error('prenom')
                                        <span class="text-error-500 text-xs mt-1 block">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        Date de naissance<span class="text-error-500">*</span>
                                    </label>
                                ...
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        Langue<span class="text-error-500">*</span>
                                    </label>
                                    <select id="langue_id" name="langue_id"
                                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                                        <option value="">-- Sélectionnez une langue --</option>
                                        @foreach($langues as $id => $name)
                                            <option value="{{ $id }}" {{ old('langue_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                    @error('langue_id')
                                        <span class="text-error-500 text-xs mt-1 block">{{ $message }}</span>
                                ...
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        Région<span class="text-error-500">*</span>
                                    </label>
